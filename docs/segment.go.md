...
```go
import "github.com/cdktf/cdktf-provider-launchdarkly-go/launchdarkly/v4/segment"
...
| <code><a href="#@cdktf/provider-launchdarkly.segment.SegmentConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/launchdarkly/launchdarkly/2.18.0/docs/resources/segment#id Segment#id}. |
