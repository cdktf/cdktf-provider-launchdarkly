...
```go
import "github.com/cdktf/cdktf-provider-launchdarkly-go/launchdarkly/v5/provider"
...
| <code><a href="#@cdktf/provider-launchdarkly.provider.LaunchdarklyProviderConfig.property.httpTimeout">HttpTimeout</a></code> | <code>*f64</code> | The HTTP timeout (in seconds) when making API calls to LaunchDarkly. Defaults to 20 seconds. |
