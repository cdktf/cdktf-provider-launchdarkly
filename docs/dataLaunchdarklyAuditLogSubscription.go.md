...
```go
import "github.com/cdktf/cdktf-provider-launchdarkly-go/launchdarkly/v5/datalaunchdarklyauditlogsubscription"
...
Refer to the {@link https://registry.terraform.io/providers/launchdarkly/launchdarkly/2.25.2/docs/data-sources/audit_log_subscription#import import section} in the documentation of this resource for the id to use
