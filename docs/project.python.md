...
| <code><a href="#@cdktf/provider-launchdarkly.project.Project.Initializer.parameter.id">id</a></code> | <code>str</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/launchdarkly/launchdarkly/2.20.1/docs/resources/project#id Project#id}. |
...
| <code><a href="#@cdktf/provider-launchdarkly.project.ProjectConfig.property.id">id</a></code> | <code>str</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/launchdarkly/launchdarkly/2.20.1/docs/resources/project#id Project#id}. |
...
| <code><a href="#@cdktf/provider-launchdarkly.project.ProjectEnvironmentsOutputReference.resetCritical">reset_critical</a></code> | *No description.* |
...
##### `reset_critical` <a name="reset_critical" id="@cdktf/provider-launchdarkly.project.ProjectEnvironmentsOutputReference.resetCritical"></a>
