...
| <code><a href="#@cdktf/provider-launchdarkly.accessToken.AccessTokenConfig.property.expire">Expire</a></code> | <code>double</code> | Replace the computed token secret with a new value. |
...
| <code><a href="#@cdktf/provider-launchdarkly.accessToken.AccessTokenConfig.property.serviceToken">ServiceToken</a></code> | <code>object</code> | Whether the token is a service token. |
