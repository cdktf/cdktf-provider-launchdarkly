...
```go
import "github.com/cdktf/cdktf-provider-launchdarkly-go/launchdarkly/v4/project"
...
Refer to the {@link https://registry.terraform.io/providers/launchdarkly/launchdarkly/2.25.0/docs/resources/project#import import section} in the documentation of this resource for the id to use
...
| <code><a href="#@cdktf/provider-launchdarkly.project.ProjectConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/launchdarkly/launchdarkly/2.25.0/docs/resources/project#id Project#id}. |
...
| <code><a href="#@cdktf/provider-launchdarkly.project.ProjectEnvironments.property.critical">Critical</a></code> | <code>interface{}</code> | Denotes whether the environment is critical. |
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktf/provider-launchdarkly.project.ProjectEnvironmentsApprovalSettings.property.autoApplyApprovedChanges">AutoApplyApprovedChanges</a></code> | <code>interface{}</code> | Automatically apply changes that have been approved by all reviewers. |
...
```go
func ResetAutoApplyApprovedChanges()
```
...
| <code><a href="#@cdktf/provider-launchdarkly.project.ProjectEnvironmentsApprovalSettingsOutputReference.property.autoApplyApprovedChangesInput">AutoApplyApprovedChangesInput</a></code> | <code>interface{}</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-launchdarkly.project.ProjectEnvironmentsApprovalSettingsOutputReference.property.serviceConfigInput">ServiceConfigInput</a></code> | <code>*map[string]*string</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-launchdarkly.project.ProjectEnvironmentsApprovalSettingsOutputReference.property.autoApplyApprovedChanges">AutoApplyApprovedChanges</a></code> | <code>interface{}</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-launchdarkly.project.ProjectEnvironmentsApprovalSettingsOutputReference.property.serviceConfig">ServiceConfig</a></code> | <code>*map[string]*string</code> | *No description.* |
...
```go
func AutoApplyApprovedChangesInput() interface{}
```
...
```go
func AutoApplyApprovedChanges() interface{}
```
...
| <code><a href="#@cdktf/provider-launchdarkly.project.ProjectEnvironmentsOutputReference.property.criticalInput">CriticalInput</a></code> | <code>interface{}</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-launchdarkly.project.ProjectEnvironmentsOutputReference.property.critical">Critical</a></code> | <code>interface{}</code> | *No description.* |
