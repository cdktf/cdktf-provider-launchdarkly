...
| <code><a href="#@cdktf/provider-launchdarkly.provider.LaunchdarklyProviderConfig.property.httpTimeout">httpTimeout</a></code> | <code>number</code> | The HTTP timeout (in seconds) when making API calls to LaunchDarkly. Defaults to 20 seconds. |
