...
| <code><a href="#@cdktf/provider-launchdarkly.metric.Metric.Initializer.parameter.id">id</a></code> | <code>str</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/launchdarkly/launchdarkly/2.21.2/docs/resources/metric#id Metric#id}. |
...
##### `reset_include_units_without_events` <a name="reset_include_units_without_events" id="@cdktf/provider-launchdarkly.metric.Metric.resetIncludeUnitsWithoutEvents"></a>
...
##### `percentile_value`<sup>Required</sup> <a name="percentile_value" id="@cdktf/provider-launchdarkly.metric.Metric.property.percentileValue"></a>
...
| <code><a href="#@cdktf/provider-launchdarkly.metric.MetricConfig.property.id">id</a></code> | <code>str</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/launchdarkly/launchdarkly/2.21.2/docs/resources/metric#id Metric#id}. |
