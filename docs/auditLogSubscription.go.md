...
```go
import "github.com/cdktf/cdktf-provider-launchdarkly-go/launchdarkly/v4/auditlogsubscription"
...
| <code><a href="#@cdktf/provider-launchdarkly.auditLogSubscription.AuditLogSubscriptionConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/launchdarkly/launchdarkly/2.23.1/docs/resources/audit_log_subscription#id AuditLogSubscription#id}. |
