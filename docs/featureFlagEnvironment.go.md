...
```go
import "github.com/cdktf/cdktf-provider-launchdarkly-go/launchdarkly/v5/featureflagenvironment"
...
&featureflagenvironment.FeatureFlagEnvironmentConfig {
	...
	EnvKey: *string,
	Fallthrough: github.com/cdktf/cdktf-provider-launchdarkly-go/launchdarkly/v5.featureFlagEnvironment.FeatureFlagEnvironmentFallthrough,
	FlagId: *string,
	OffVariation: *f64,
