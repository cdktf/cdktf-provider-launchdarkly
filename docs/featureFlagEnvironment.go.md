...
| <code><a href="#@cdktf/provider-launchdarkly.featureFlagEnvironment.FeatureFlagEnvironmentConfig.property.on">On</a></code> | <code>interface{}</code> | Whether targeting is enabled. |
...
| <code><a href="#@cdktf/provider-launchdarkly.featureFlagEnvironment.FeatureFlagEnvironmentConfig.property.trackEvents">TrackEvents</a></code> | <code>interface{}</code> | Whether to send event data back to LaunchDarkly. |
...
| <code><a href="#@cdktf/provider-launchdarkly.featureFlagEnvironment.FeatureFlagEnvironmentContextTargets.property.variation">Variation</a></code> | <code>*f64</code> | Index of the variation to serve if a user_target is matched. |
...
| <code><a href="#@cdktf/provider-launchdarkly.featureFlagEnvironment.FeatureFlagEnvironmentFallthrough.property.variation">Variation</a></code> | <code>*f64</code> | The integer variation index to serve in case of fallthrough. |
...
| <code><a href="#@cdktf/provider-launchdarkly.featureFlagEnvironment.FeatureFlagEnvironmentTargets.property.variation">Variation</a></code> | <code>*f64</code> | Index of the variation to serve if a user_target is matched. |
