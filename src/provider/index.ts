...
// https://registry.terraform.io/providers/launchdarkly/launchdarkly/2.21.0/docs
...
export class LaunchdarklyProvider extends cdktf.TerraformProvider {
  ...
  * @param importFromId The id of the existing LaunchdarklyProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/launchdarkly/launchdarkly/2.21.0/docs#import import section} in the documentation of this resource for the id to use
