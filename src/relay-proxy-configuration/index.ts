// https://registry.terraform.io/providers/launchdarkly/launchdarkly/2.24.0/docs/resources/relay_proxy_configuration
...
export class RelayProxyConfiguration extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing RelayProxyConfiguration that should be imported. Refer to the {@link https://registry.terraform.io/providers/launchdarkly/launchdarkly/2.24.0/docs/resources/relay_proxy_configuration#import import section} in the documentation of this resource for the id to use
