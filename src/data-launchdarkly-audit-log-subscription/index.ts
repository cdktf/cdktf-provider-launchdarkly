// https://registry.terraform.io/providers/launchdarkly/launchdarkly/2.18.3/docs/data-sources/audit_log_subscription
...
export interface DataLaunchdarklyAuditLogSubscriptionConfig extends cdktf.TerraformMetaArguments {
  ...
  */
  readonly id: string;
  /**
  * The integration key. Supported integration keys are `chronosphere`, `cloudtrail`, `datadog`, `dynatrace`, `elastic`, `grafana`, `honeycomb`, `logdna`, `msteams`, `new-relic-apm`, `signalfx`, `slack`, and `splunk`.
  *
